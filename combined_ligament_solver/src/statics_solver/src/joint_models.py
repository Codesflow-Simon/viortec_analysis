...
class AsymmetricTwoBallJoint(JointModel):
    """
    A joint made of two balls and a frame that rocks over them. This defines the position of the child frame. Allows for different ball radii.
    Args:
        body_frame: The child frame of the joint.
        world_frame: The world frame of the joint.
        distance: The horizontal distance from the center of the joint to ball center.
        distance_2: Optional distance from the center of the joint to the other ball center, otherwise symmetric.
        radius_1: The radius of the left ball.
        radius_2: The radius of the right ball.
        slide: If the joint is sliding, rather than rolling.
    """
    def __init__(self, body_frame: ReferenceFrame, world_frame: ReferenceFrame, distance, distance_2=None, radius_1=None, radius_2=None, slide=True):
        self.body_frame = body_frame
        self.world_frame = world_frame
        self.distance = distance
        self.distance_2 = distance_2 if distance_2 is not None else distance
    ...
    def get_ball_centers(self, theta):
        return [Point([-self.distance,  -self.radius_1, 0], self.world_frame), 
                Point([self.distance_2, -self.radius_2, 0], self.world_frame)]
